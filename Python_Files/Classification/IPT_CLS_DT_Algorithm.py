# -*- coding: utf-8 -*-
"""
Created on Tue Dec  6 19:07:47 2022
...
import Classification.Calculate_Score as cs
# -----------------------------------------------------------------------------


def Decision_Tree_Algorithm(X_train, X_test, y_train, y_test, y_str, df, mx_depth=0):
    return_values = {}
    ...
    ax.xaxis.set_ticklabels(['Başarılı', 'Başarısız'])
    ax.yaxis.set_ticklabels(['Başarılı', 'Başarısız'])
